    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <p id="module_1">
                    <img src="Foto/Vragen_Notities.jpg" width="100" height="75" />
                    Vragen/notities maken en noteren in je logboek:
                    <br>
                    Maak uit het werkboek van Nu Pedagogisch Werk, Basisboek Didactiek, Communicatie en Organisatie vraag 5 op blz. 101.
                    <br>
