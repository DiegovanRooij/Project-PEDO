    ...
    <div id="page-content-wrapper">
      ...
      <div class="invisible" id="makes">
        ...
        <p id="theorie_tekst">
          <img src="Foto/Theorie_Lezen.jpg" width="100" height="75" />
          <br>
          Lees: NU Pedagogisch Werk basisboek: Didactiek, Communicatie en Organisatie -> vanaf het kader “Werken in de
          praktijk” t/m Voeding (blz. 187 én blz. 188)
          <br>
        ...
        <p>
          Lees: NU Pedagogisch Werk basisboek: Didactiek, Communicatie en Organisatie à vanaf het kader “Werken in de
          praktijk” t/m Voeding (blz. 187 én blz. 188) Zoek in het boek op wat ‘ergonomisch verantwoord werken’ is.
        </p>
      </div>
    </div>
